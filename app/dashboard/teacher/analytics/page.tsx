...
export default function AnalyticsPage() {
  ...
  useEffect(() => {
    ...
    const fetchAnalytics = async () => {
      ...
      const userScores: { [key: string]: UserScore } = submissions?.reduce(
        (acc: { [key: string]: UserScore }, sub: any) => {
      ...
      const chart: ChartData = {
        labels: Object.values(userScores).map((u) => u.name),
        datasets: [
          {
            label: 'Total Score',
            data: Object.values(userScores).map((u) => u.score),
          ...
          {
            label: 'Submissions',
            data: Object.values(userScores).map((u) => u.count),
